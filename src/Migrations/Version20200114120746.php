 ...
 */
final class Version20200114120746 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE lesson DROP FOREIGN KEY FK_F87474F3909E143A');
        $this->addSql('ALTER TABLE lesson DROP FOREIGN KEY FK_F87474F36072F18B');
        $this->addSql('ALTER TABLE lesson ADD CONSTRAINT FK_F87474F3909E143A FOREIGN KEY (training_id_id) REFERENCES training (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE lesson ADD CONSTRAINT FK_F87474F36072F18B FOREIGN KEY (intructor_id) REFERENCES user (id) ON DELETE CASCADE');
